...
// Animation constants
const letterVariants = (animate: boolean, duration = 4) => {
...
const edgeVariants = (animate: boolean, duration = 4) => {
...
const AnimatedIcon: React.FC<AnimatedIconProps> = () => {
  ...
  return (
    ...
    >
      <motion.path
        variants={letterVariants(home, 2)}
      ...
      />
      {/* Right */}
      <motion.path variants={edgeVariants(home, 2)} d="M 64 65 v -64 h -19" />
      {/* Bottom left */}
      <motion.path variants={edgeVariants(home, 2)} d="M 20 64 h -19 v -48" />
      {/* Bottom Right */}
      <motion.path variants={edgeVariants(home, 1)} d="M 19 64 h 45" />
      {/* Left */}
      <motion.path variants={edgeVariants(home, 2)} d="M 1 1 v 16" />
      {/* Top */}
      <motion.path variants={edgeVariants(home, 2)} d="M 0 1 h 46" />
    </motion.svg>
  );
};
